...
(function (window, $) {
  ...
  window.JTracker = {
     ...
     */
    preview: function preview(text, _preview) {
      var out = $(_preview);
     ...
     */
    updateTests: function updateTests(testsSuccess, testsFailure) {
    ...
    setupAtJS: function setupAtJS(id, projectAlias) {
      ...
      $('#' + id).atwho(emoji_config).atwho(user_config).atwho(issue_config);
    }
  };
})(window, jQuery);
/******/ })()
