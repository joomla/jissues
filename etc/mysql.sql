...
CREATE TABLE `#__tracker_milestones` (
  ...
  `description` mediumtext NULL COMMENT 'Milestone description',
...
CREATE TABLE IF NOT EXISTS `#__issues` (
  ...
  `description` mediumtext NULL COMMENT 'Issue description',
  `description_raw` mediumtext NULL COMMENT 'The raw issue description (markdown)',
