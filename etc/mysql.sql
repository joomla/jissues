...
--
-- Table structure for table `#__releases`
--
...
CREATE TABLE `#__releases` (
  ...
  `notes` mediumtext NOT NULL DEFAULT '' COMMENT 'The HTML formatted release notes',
  `notes_raw` mediumtext NOT NULL DEFAULT '' COMMENT 'The raw release notes (markdown)',
  PRIMARY KEY (`id`),
  KEY `name` (`name`),
