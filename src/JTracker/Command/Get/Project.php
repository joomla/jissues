...
use JTracker\Command\Get\Project\Comments;
use JTracker\Command\Get\Project\Events;
use JTracker\Command\Get\Project\Issues;
use JTracker\Command\Get\Project\Labels;
use JTracker\Command\Get\Project\Milestones;
...
class Project extends Get
{
    ...
    {
        $issue = (int) $input->getOption('issue');

        $rangeFrom = (int) $input->getOption('range_from');
        $rangeTo   = (int) $input->getOption('range_to');
